            ...
            >
                ...
                <div className="w-full md:w-1/2 bg-gradient-to-tr from-purple-900/30 via-gray-800/60 to-blue-900/30 flex items-center justify-center p-2 border-r border-purple-900">
                    {asset.mediaUrl ? (
                        ...
                        <div className="p-8 text-gray-500">No Image</div>
                    )}
                </div>
                ...
                <div className="w-full md:w-1/2 p-6 overflow-y-auto flex flex-col custom-scrollbar">
                    <div className="flex justify-between items-start mb-4">
                        <h2 className="text-3xl font-extrabold text-purple-300 tracking-tight pr-10">
                    ...
                    <div className="flex-grow space-y-4">
                        ...
                        <div className="space-y-2 pt-4 border-t border-purple-900/40 text-sm">
                            ...
                            <DetailRow label="Children" value={asset.childrenCount} />
                            {asset.analytics && (
                                <>
                                    <DetailRow label="Dispute Status" value={asset.analytics.disputeStatus} />
                                    <DetailRow label="Royalty Split" value={asset.analytics.royaltySplit} />
                                </>
                            )}
                        </div>
                    </div>
