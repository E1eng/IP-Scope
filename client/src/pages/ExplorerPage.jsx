        ...
        {isLoading && (
          <div className="space-y-6 animate-fade-in">
            ...
            <div className="mb-6">
              ...
              <p className="text-xs text-gray-400 mt-2 text-center">Loading data... please wait (it takes longer if you have a lot of transactions)</p>
                        </div>
                ...
                {getSortedResults().map((asset, index) => (
                  ...
                  >
                    ...
                    <div className="p-4 space-y-3">
                      ...
                      {/* IP ID - Clickable */}
                      <div className="flex items-center justify-between space-x-2 group/ipid">
                        <div className="flex items-center space-x-2 min-w-0 flex-1">
                          <span className="text-xs text-gray-500">IP ID:</span>
                          <span className="text-xs font-mono text-indigo-400 truncate">
                            {asset.ipId?.substring(0, 6)}...{asset.ipId?.substring(asset.ipId.length - 4)}
                          </span>
                        </div>
                        <a
                          ...
                          className="text-indigo-400 hover:text-indigo-300 opacity-0 group-hover/ipid:opacity-100 transition-smooth"
